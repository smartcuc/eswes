...
export default function EnergyFlow({ data }) {
    ...
    useEffect(() => {
        ...
        fetch(data.endpoint)
            ...
            .then(setFlowData)
            .catch(err => {
                console.error("EnergyFlow error:", err);
...
function fakeFlow() {
    return {
        nodes: [
            { id: "solar", name: "PV", x: 100, y: 200, type: "solar" },
            { id: "home", name: "Haus", x: 300, y: 200 },
            { id: "grid", name: "Netz", x: 500, y: 200, type: "grid" }
        ],
        flows: [
            {
                id: "f1",
                ...
                value: 3.2,
                unit: "kWh",
                path: "M100,200 C180,150 220,150 300,200",
                color: "#f59e0b"
            },
            {
                id: "f2",
                ...
                value: 1.1,
                unit: "kWh",
                path: "M300,200 C380,250 420,250 500,200",
                color: "#3b82f6"
            }
        ]
    };
