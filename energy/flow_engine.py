...
def calculate_energy_flow(signals):
    ...
    return {
        "pv_to_load": pv.get("production") or 0,
        "pv_to_battery": battery.get("charge") or 0,
        "pv_to_grid": grid.get("export") or 0,
        "battery_to_load": battery.get("discharge") or 0,
        "grid_to_load": grid.get("import") or 0,
    }
